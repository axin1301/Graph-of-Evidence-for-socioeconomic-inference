...
OPENROUTER_HTTP_REFERER = os.getenv("OPENROUTER_HTTP_REFERER", "https://github.com/openai/codex")
OPENROUTER_APP_TITLE = os.getenv("OPENROUTER_APP_TITLE", "UrbanAgent-Framework-EOG")
